<div class="row">
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn blue modal-trigger" href="#more?id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Detail</a> <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Laporan?')" href="index.php?p=tanggapan_hapus&id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Hapus</a></td>
