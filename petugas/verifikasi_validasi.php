        <div class="row">
          <div class="col s12 mt-5">
            <h3 class="black-text">Verifikasi Dan Validasi</h3>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn blue modal-trigger text-light" href="#more?id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Detail</a> 
			<a class="btn red text-light" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=tanggapan_hapus&id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Hapus</a></td>
